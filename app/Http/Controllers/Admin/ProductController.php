...
class ProductController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->editColumn('Subcategory', function ($data) {
                    return $data->Subcategory->en_Subcategory_Name;
                })
                ...
                ->rawColumns(['action','PrimaryImage','Subcategory','Category','Price','Status'])
                ->make(true);
        }
    ...
    public function categoryselect(Request $request){
        $data = Subcategory::where('en_Category_id',$request->data)->get();
    ...
    public function physicalProductAdd($data)
    {
        ...
        $product = Product::create([
            ...
            'Subcategory_id' => $data['en_subcategory_name'],
            'Price' => $data['price'],
    ...
    public function physicalProductUpdate($data, $product)
    {
        ...
        $update = $product->update([
            ...
            'Subcategory_id' => is_null($data['en_subcategory_name']) ? $product->Subcategory_id : $data['en_subcategory_name'],
