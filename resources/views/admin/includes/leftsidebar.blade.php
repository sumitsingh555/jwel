        ...
        <li class="{{ isset($menu) && $menu == 'products' ? 'mm-active' : ''  }}">
            ...
            <ul>
                ...
                <li class="{{isset($submenu) && $submenu == 'size' ? 'mm-active' : '' }}">
                 ...
                 <li class="{{isset($submenu) && $submenu == 'purity' ? 'mm-active' : '' }}">
                    <a href="{{route('admin.product.purity')}}">
                        <i class="fa fa-circle"></i>
                        <span>{{ __('Product Purity')}}</span>
                    </a>
                </li>
                 <li class="{{isset($submenu) && $submenu == 'diamondclarity' ? 'mm-active' : '' }}">
                    <a href="{{route('admin.product.diamondclarity')}}">
                        <i class="fa fa-circle"></i>
                        <span>{{ __('Diamond Clarity')}}</span>
                    </a>
                </li>
            </ul>
        </li>
