                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <select class="form-control" id="en_category_name" name="en_category_name"  onchange="mycategory()">
                                                    <option>{{__('---Select item---')}}</option>
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Subcategory Name')}}</label>
                                                <select class="form-control" id="en_subcategory_name" name="en_subcategory_name">
                                                    <option>{{__('---Select item---')}}</option>
...
<script>
   function mycategory(){
    var data = $('#en_category_name').val();
 
    $.ajax({
              url:"{{route('admin.product.categoryselect')}}",
              method:"POST",
              headers: {
              ...
              success:function(data){
                ...
                $.each(data,function(index ,value){
                  console.log(value.id);
                        ...
                        $('#en_subcategory_name').append (`<option class="text-dark" value="`+value.id+`">`+value.en_Subcategory_Name+`</option>`)
