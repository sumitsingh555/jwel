                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-vertical__item bg-style">
                                        <form enctype="multipart/form-data" method="POST" action="{{route('admin.product.diamondclarity.store')}}">
                                            @csrf
                                            <input type="hidden" name="id">
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Diamond Clarity')}}</label>
                                                <input type="text" id="size" name="diamondclarity">
                                            </div>
