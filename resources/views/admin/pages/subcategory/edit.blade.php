                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <form enctype="multipart/form-data" method="POST"action="{{route('admin.subcategory.update')}}">
                                            @csrf
                                            <div class="input__group mb-25">
                                                ...
                                                <select name="en_category_id">
                                                    ...
                                                    <option  <?php echo ($value->en_Category_Name == $data->en_Category_id) ?  'selected' : '' ?>>{{$value->en_Category_Name}}</option>
                                                    @endforeach
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="en_subcategory_name" name="en_subcategory_name" value="{{$data->en_Subcategory_Name}}">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label>{{ __('Subcategory Name '.langString('fr'))}}</label>
                                                <input type="text" id="fr_subcategory_name" name="fr_subcategory_name"  value="{{$data->fr_Subcategory_Name}}">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label>{{ __('Icon Class')}}</label>
                                                <input type="text" id="icon_class" name="icon_class"  value="{{$data->Subcategory_Icon}}">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label>{{__('Description '.langString('en'))}}</label>
                                                <textarea name="en_description" id="en_description" >{{$data->en_Description}}</textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                                <label>{{__('Description '.langString('fr'))}}</label>
                                                <textarea name="fr_description" id="fr_description" >{{$data->fr_Description}}</textarea>
                                            </div>
