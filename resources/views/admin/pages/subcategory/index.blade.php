...
@section('content')
        ...
        <div class="col-md-12">
            <div class="customers__area bg-style mb-30">
                <div class="item-title">
                    <div class="col-xs-6">
                        <a href="{{route('admin.subcategory.create')}}" class="btn btn-md btn-info">{{ __('Add Subcategory')}}</a>
                    </div>
                </div>
                <div class="subcustomers__table">
    ...
    @push('post_scripts')
        ...
        <script src="{{asset('backend/js/admin/datatables/subcategory.js')}}"></script>
