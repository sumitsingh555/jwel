...
Route::group(['prefix' => 'admin','middleware' => ['auth','is_admin', 'en.locale'],'as' =>'admin.'],function(){
    ...
    Route::group(['prefix' => 'category'],function (){
      ...
      Route::group(['prefix' => 'subcategory'],function (){
        ...
        Route::get('/inactive/{d}', [SubCategoryController::class, 'subcategoryInactive'])->name('subcategory.inactive');
    ...
    Route::group(['prefix' => 'product'],function (){
        ...
        Route::post('categoryselect',[ProductController::class,'categoryselect'])->name('product.categoryselect');
    });
    ...
    Route::group(['prefix' => 'product-size'],function (){
      ...
      Route::group(['prefix' => 'product-purity'],function (){
        Route::get('', [PurityController::class, 'productPurity'])->name('product.purity');
        Route::get('/create', [PurityController::class, 'productPurityCreate'])->name('product.purity.create');
        Route::post('/create', [PurityController::class, 'productPurityStore'])->name('product.purity.store');
        Route::get('/edit/{id}', [PurityController::class, 'productPurityEdit'])->name('product.purity.edit');
        Route::post('/update', [PurityController::class, 'productPurityUpdate'])->name('product.purity.update');
        Route::get('/delete/{id}', [PurityController::class, 'productPurityDelete'])->name('product.purity.delete');
    });
   
       Route::group(['prefix' => 'product-diamondclarity'],function (){
        Route::get('', [DiamondClarityController::class, 'diamondclarity'])->name('product.diamondclarity');
        Route::get('/create', [DiamondClarityController::class, 'diamondclarityCreate'])->name('product.diamondclarity.create');
        Route::post('/create', [DiamondClarityController::class, 'diamondclarityStore'])->name('product.diamondclarity.store');
        Route::get('/edit/{id}', [DiamondClarityController::class, 'diamondclarityEdit'])->name('product.diamondclarity.edit');
        Route::post('/update', [DiamondClarityController::class, 'diamondclarityUpdate'])->name('product.diamondclarity.update');
        Route::get('/delete/{id}', [DiamondClarityController::class, 'diamondclarityDelete'])->name('product.diamondclarity.delete');
    });
    ...
    Route::get('/customer/{status}/{user_id}', [UserController::class, 'customerStatusChange'])->name('customer_status_change')->middleware(['permission:user-list|user-create|user-edit|user-delete']);
