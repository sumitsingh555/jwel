...
Route::get('/example2', function(){return view('frontend/example'); });
// Route::get('/newdesign', function(){return view('frontend/index'); });
Route::get('/',[FrontHomeController::class,'index']);

Route::post('designdata',[OrderController::class,'designdata'])->name('designdata');
Route::post('designvalue',[OrderController::class,'designvalue'])->name('designvalue');
Route::post('selectcategory',[OrderController::class,'selectcategory'])->name('selectcategory');
Route::post('form2data',[OrderController::class,'form2data'])->name('form2data');
Route::any('searchsku',[OrderController::class,'searchsku'])->name('searchsku');
